...
cropperModal = function ( data ) {
    ...
    var html = '<div class="modal member-crop-modal" id="crop-modal" data-backdrop="static">\n' +
        ...
        '                    <div class="crop-close j-crop-close">×</div>\n' +
        '                </div>\n' +
        '            </div>\n' +
        '            <div class="modal-footer">\n' +
        '                <div class="pull-left crop-notice"></div>\n' +
        '                <div class="btn btn-primary j-crop-apply" data-loading-text="'+data.loading+'">'+data.apply+'</div>\n' +
        '                <div class="btn btn-default" data-dismiss="modal">'+data.cancel+'</div>\n' +
        '            </div>\n' +
        '        </div>\n' +
        '    </div>\n' +
        '</div>';
